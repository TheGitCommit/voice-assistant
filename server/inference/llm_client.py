...
class LLMClient:
    ...
    def __init__(self, config: LlamaConfig, session_id: Optional[str] = None):
        ...
        self.system_instruction = (
            ...
            "\n\n"
            "KNOWLEDGE BASE: You may receive [RETRIEVED CONTEXT] sections with relevant information from the user's local documents. "
            "When context is provided, use it to answer questions accurately. "
            "Cite the source when referencing retrieved information (e.g., 'According to your notes...' or 'In your document...'). "
            "If the context doesn't contain relevant information, say so naturally. "
            "\n\n"
